...
function Boton(props) {
    ...
    return (
        ...
        // aqui agregamos nuestro evento Clic el cual llama a una función anónima y ésta retorna el resultado de llamar a la función manejarClic()
        onClick={() => props.manejarClic(props.children)}>  {/* en vez de null le ponemos '' y quitamos el espacio final */}
